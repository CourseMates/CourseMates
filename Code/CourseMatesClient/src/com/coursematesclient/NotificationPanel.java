...
//		notificationListView.setAdapter(adapter);
	...
	//	ImageAndTextAdapter ia = new ImageAndTextAdapter(ctx, R.layout.notification_item,Utils.msgList);
		...
		notificationListView.setAdapter(new ArrayAdapter<String>(this,  android.R.layout.simple_list_item_1, Utils.msgList));
		...
		notificationListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				finish();
	        	Intent intent = new Intent(NotificationPanel.this, SplashScreen.class);
